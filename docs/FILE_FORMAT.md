...
7. **Two writers, no shared schema.** The Rust crate and `buildDocumentJson`
   ...
   **FIXED 2026-09-07:** one writer — `buildDocumentJson` routes through
   ...
   `docs/schema/waffle-v4.schema.json` (§12) and pinned in CI.
