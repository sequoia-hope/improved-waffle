...
JSON Schema golden; §2.9 profile addressing landed 2026-09-08; §2.10 is
OPEN — see `projects/09-file-format/PLAN.md`). Plan of record for the file-format
